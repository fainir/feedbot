...
export default function ForYouPage() {
  ...
  return (
    <div className="min-h-screen bg-bg text-text">
      ...
      {/* Feed content */}
      <main id="main-content" className="max-w-5xl mx-auto px-4 sm:px-6 pb-6">
        {loading ? (
      ...
      <footer className="border-t border-border py-6 mt-8">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-wrap items-center justify-center gap-4 text-[11px] text-text-muted">
