    ...
    <div className="min-h-screen bg-bg text-text">
      ...
      {!user && !heroDismissed && (
        <div className="max-w-2xl mx-auto px-4 pt-3">
          <div className="relative rounded-3xl border border-border overflow-hidden shadow-sm p-6 sm:p-8 bg-gradient-to-br from-indigo-50 via-white to-amber-50 dark:from-indigo-950/40 dark:via-bg-card dark:to-amber-950/30">
